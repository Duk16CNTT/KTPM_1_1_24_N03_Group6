...
$(document).ready(function () {
    ...
    $('#form-register').submit(function () {
        ...
        currentLocation = "http://localhost/Quan-Ly-Chi-Tieu" + "/account/Register";
    ...
    $('#form-login').submit(function () {
        ...
        event.preventDefault();
        var currentLocation = window.location;
        currentLocationHome = "http://localhost/Quan-Ly-Chi-Tieu" + "/home/overview";
        currentLocation = "http://localhost/Quan-Ly-Chi-Tieu" + "/account/login_processing";
